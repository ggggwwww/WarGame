...
<head>
    ...
    <title>The Seventh Star: Problem 07</title>
...
<body>
    ...
    <div id="problem-container">
        ...
        ?>
            <p>Available IP addresses on our intranet.</p>
            <ul>
                <li>10.0.0.8</li>
                <li>172.34.88.3</li>
                <li>192.105.40.129</li>
            </ul>
        <?php
        }
        ?>
        ...
        <div id="flag-submission">
            <form action="submit_flag.php" method="POST">
                ...
                <input type="hidden" id="problem_num" name="problem_num" value="7">
