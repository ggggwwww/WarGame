...
<body>
    ...
    <div id="problem-container">
        <h1>Problem 9</h1>
        <div id="content-area">
            <form method="POST" action="/starmap/vulnerable_update.php">
                <input type="hidden" name="email" value="admin-verified@target.local">
            </form>
        </div>
        ...
        <div id="flag-submission">
            <form action="submit_flag.php" method="POST">
                ...
                <input type="hidden" id="problem_num" name="problem_num" value="9">
